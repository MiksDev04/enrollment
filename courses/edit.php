...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssiii", $course_code, $course_name, $description, $credits, $capacity, $id);
...
<head>
    ...
    <title>Edit Course - Enrollment System</title>
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <form method="POST" class="mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="credits" name="credits" value="<?= htmlspecialchars($course['credits']) ?>" required min="1">
                    </div>
                    <div class="mb-3">
                        <label for="capacity" class="form-label">Capacity</label>
                        <input type="number" class="form-control" id="capacity" name="capacity" value="<?= htmlspecialchars($course['capacity']) ?>" required min="1">
                    </div>
                    <div class="mb-3">
