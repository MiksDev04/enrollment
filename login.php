...
<body>
    <div class="container">
        <div class="login-container">
            <div class="login-header position-relative d-flex align-items-center justify-content-center">
                <a href="home.php" class=" position-absolute btn text-white d-flex align-items-center gap-2" style="left: 1rem;">
